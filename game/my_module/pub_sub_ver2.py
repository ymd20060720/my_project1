...
class Broker:
    ...
    def event_add(self, event_name: str, event_content: Any) -> None:
        """
...
class Publisher:
    ...
    def publish_event(self, event_name: str, event_content: Any) -> None:
        """
        Publish a new event.
        ...
        Args:
            ...
            event_content (Any): The content of the event.
        """
        self.broker.event_add(event_name, event_content)
        self.broker.notify_subscribers(event_name)
...
def test() -> None:
    ...
    for i in range(3):
        ...
        output_class.update()
        print(input_class.publisher.broker.events)
        print(input_class.publisher.broker.events_subscribers)
    
    print("\nUnsubscribing from 'x_change' event:")
    output_class.subscriber.unsubscribe('x_change')
    input_class.change_x(10)
    output_class.update()
    print(input_class.publisher.broker.events)
    print(input_class.publisher.broker.events_subscribers)
